...
def find_term_time(start_jd, end_jd, target_degrees):
    """Find exact time when sun longitude equals target_degrees
    ...
    def condition(jd):
        ...
        # Assuming we are close (within 1 day), jump shouldn't be large
        # except at 0.
    ...
    while current_date < end_date:
        ...
        for target in TERM_ANGLES.keys():
            ...
            if hit:
                ...
                # Actually, find_term_time uses radians and normalization,
                # should be ok if close.
